...
public:
	...
	// --- 3 Attributes
	static inline const FFriendlyNameAttribute FriendlyName { u8"测试基类型A"N };
	static inline const FDisplayColorAttribute DisplayColor { 10, 23, 23 };

	static inline const TReferenceWrapper<const FAttribute> ReflectedAttributes[] =
	{
		FriendlyName,
		DisplayColor,
	};
	...
	// --- 4 Type
	inline const FGlobalParameters_Type(FName Name = u8"FGlobalParameters"N) : TType<FGlobalParameters>(Name, FType::None)
	{
		FType::Constructors = ReflectedConstructors;
		FType::Attributes = ReflectedAttributes;
	}
};
...
public:
	...
	// --- 4 Type
	inline const FTestClassBaseA_Type(FName Name = u8"FTestClassBaseA"N) : TType<FTestClassBaseA>(Name, FType::None)
	{
		FType::Constructors = ReflectedConstructors;
		FType::Methods = ReflectedMethods;
		FType::Attributes = ReflectedAttributes;
	}
};
...
public:
	...
	// --- 3 Attributes
	static inline const FFriendlyNameAttribute FriendlyName { u8"测试基类型B"N };
	static inline const FDisplayColorAttribute DisplayColor { 10, 23, 23 };
	...
	// --- 4 Type
	inline const FTestClassBaseB_Type(FName Name = u8"FTestClassBaseB"N) : TType<FTestClassBaseB>(Name, FType::None)
	{
		FType::Constructors = ReflectedConstructors;
		FType::Methods = ReflectedMethods;
		FType::Attributes = ReflectedAttributes;
...
public:
	...
	// --- 3 Attributes
	static inline const FFriendlyNameAttribute FriendlyName { u8"测试类型"N };
	static inline const FDisplayColorAttribute DisplayColor { 12, 23, 23 };
	...
	// --- 4 Type
	inline const FTestClass_Type(FName Name = u8"FTestClass"N) : TType<FTestClass>(Name, FTestClassBaseA::StaticType())
	{
		FType::Constructors = ReflectedConstructors;
		FType::Methods = ReflectedMethods;
		FType::Properties = ReflectedProperties;
		FType::Attributes = ReflectedAttributes;
	}
};
