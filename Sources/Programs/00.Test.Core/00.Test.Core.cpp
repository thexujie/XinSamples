...
int main(int argc, const char * args[])
{
	...
	FConsole::WriteLineF(u8"FString.Name={}"V, FString::StaticType().Name);
	...
	FConsole::WriteLineF(u8"NameXJ={} and {}"V, NameFF.Resolve(), NameXJ.Resolve());
	...
	const TAttribute<FName> & FriendlyName = Class.FindAttributeT<FName>(u8"FriendlyName"N);
	const TAttribute<FColor> & DisplayColor = Class.FindAttributeT<FColor>(u8"DisplayColor"N);
